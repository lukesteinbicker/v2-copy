...
import { DataTableResetButton } from "~/components/function/data-table/components/src/data-table/data-table-reset-button";
import { MemoizedDataTableSheetContent } from "~/components/function/data-table/components/src/data-table/data-table-sheet/data-table-sheet-content";
import { DataTableSheetDetails } from "~/components/function/data-table/components/src/data-table/data-table-sheet/data-table-sheet-details";
import { DataTableToolbar } from "~/components/function/data-table/components/src/data-table/data-table-toolbar"; // TODO: check where to put this
import type {
...
import { useLocalStorage } from "~/components/function/data-table/components/src/hooks/use-local-storage";
import { formatCompactNumber } from "~/components/function/data-table/components/src/lib/format";
import { arrSome, inDateRange } from "~/components/function/data-table/components/src/lib/table/filterfns";
...
export function DataTableInfinite<TData, TValue, TMeta>({
  ...
  const table = useReactTable({
    ...
    debugAll: process.env.VITE_TABLE_DEBUG === "true",
                    ...
                    {headerGroup.headers.map((header) => {
                      return (
                        <TableHead
                          key={header.id}
                          className={cn(
                            "relative select-none truncate border-b border-border last:[&>.cursor-col-resize]:opacity-0",
  ...
  return (
    <TableRow
      ...
      className={cn(
        ...
        "outline-none -outline-offset-1 transition-colors focus-visible:bg-muted/50 focus-visible:outline-1 focus-visible:outline-primary data-[state=selected]:outline-1 data-[state=selected]:outline-primary",
