import { DataTableSkeleton } from "~/components/function/data-table/components/src/data-table/data-table-skeleton";
import { Skeleton as DefaultSkeleton } from "~/components/function/utility/skeleton";
